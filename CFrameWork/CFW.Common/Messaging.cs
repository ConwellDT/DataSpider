...
namespace CFW.Common
{
	...
	public class Messaging
	{
		...
		#region GetErrorMessage : Error 메시지 and Error 정보
		...
		#region -- SearchMsgStr (CS) : Searching and returning message string
		...
		public static bool LoadMsgList(string languageType, ref string sErrCode, ref string sErrText)
		{
			...
			{
                languageType = CFW.Configuration.ConfigManager.Default.ReadConfig("CULTURE", "CULTURE_DEFALT");		
			}	
		...
		{
            string reLanguage = CFW.Configuration.ConfigManager.Default.ReadConfig("CULTURE", "CULTURE_DEFALT");
			return reLanguage;
		}
		#endregion
	}
