...
namespace CFW.Data
{
    public class MySqlDbAccess
    {
        ...
        protected MySqlCommand     mCommand;
        protected MySqlDataReader  mReader;
        protected MySqlTransaction mTrans;
        ...
        public bool DBConnect()
        {
            try
            {
                this.mConStr = MySqlDbDef.ConnectionString;
        ...
        public bool DBConnect(string p_strConnectionString)
        {
            try
            {
                this.mCon = new MySqlConnection(p_strConnectionString);
                this.mCon.Open();
        ...
        private void TransactionDBConnect(string p_strUSER, string p_strPW, string p_strAlias)
        {
            try
            {
                mCon = new MySqlConnection("user id		= " + p_strUSER + ";"  +
        ...
        public static bool DBConnectCheck()
        {
            ...
            try
            {
                ...
                conn = new MySqlConnection(MySqlDbDef.ConnectionString);
                conn.Open();
        ...
        public static bool ExecuteNonQuery(string commandText, MySqlParameter[] oraParameters, CommandType commandType, ref string p_strErrCode, ref string p_strErrText)
        {
            ...
            try
            {
                ...
                {
                    foreach (MySqlParameter param in oraParameters)
                    {
                        mCommand.Parameters.Add(param);
                    }
                }

                mCon = new MySqlConnection(MySqlDbDef.ConnectionString);
                mCon.Open();
        ...
        public int ExecuteMultiple(string commandText, MySqlParameter[] oraParameters, string[,] paramValues, CommandType commandType, ref string p_strErrCode, ref string p_strErrText)
        {
        ...
        public MySqlDataReader ExecuteReader(string commandText, MySqlParameter[] mySqlParameters, CommandType commandType, ref string p_strErrCode, ref string p_strErrText)
        {
            try
            {
                mCommand = mCon.CreateCommand();
        ...
        private object ExecuteScalarObject(string commandText, MySqlParameter[] oraParameters, CommandType commandType)
        {
            object objRet = null;
        ...
        public bool ExecuteScalar(string commandText, MySqlParameter[] oraParameters, CommandType commandType, ref string p_strValue, ref string p_strErrCode, ref string p_strErrText)
        {
            object objRet = null;
        ...
        public static DataSet GetDataSet(string commandText, MySqlParameter[] oraParameters, CommandType commandType, ref string p_strErrCode, ref string p_strErrText)
        {
            MySqlConnection mCon = null;
            MySqlCommand mCommand = null;
            ...
            try
            {
                ...
                da = new MySqlDataAdapter(mCommand);
                da.Fill(dsReturn);
