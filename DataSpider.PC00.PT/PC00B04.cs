...
namespace DataSpider.PC00.PT
{
    ...
    public class PC00B04 : PC00B01
    {
        ...
        public PC00B04(IPC00F00 pOwner, DataRow dr, string equipType, string equipName, string connectionInfo, string extraInfo, int nCurNo, bool bAutoRun) : base(pOwner, dr, equipType, equipName, connectionInfo, extraInfo, nCurNo, bAutoRun)
        {
        }
