            ...
            try
            {
                ...
                switch (equipType)
                {
                    ...
                    case "PCM_S470-K_V2":
                        ...
                        break;
                    case "PCM_S470-K_V3":
                        thProcess = new PC01S33[dtEquipment.Rows.Count];
                        foreach (DataRow dr in dtEquipment.Rows)
                        {
                            thProcess[i++] = new PC01S33(this, dr, i, true);
                        }
                        break;
                    case "PCM_S47_MULTI":
                    ...
                    case "SC_MCA":
                        ...
                        break;
                    case "OSMO_TECH":
                        thProcess = new PC01S19[dtEquipment.Rows.Count];
                        foreach (DataRow dr in dtEquipment.Rows)
                        {
                            thProcess[i++] = new PC01S19(this, dr, i, true);
                        }
                        break;
                    case "Vi-CELL_BLU":
                        thProcess = new PC01S20[dtEquipment.Rows.Count];
                        foreach (DataRow dr in dtEquipment.Rows)
                        {
                    ...
                    case "CEDEX_BIO_HT":
                        ...
                        break;
                    case "RAPIDPoint_500e":
                        thProcess = new PC01S34[dtEquipment.Rows.Count];
                        foreach (DataRow dr in dtEquipment.Rows)
                        {
